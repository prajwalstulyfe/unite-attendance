...
import { Building2, Mail, Lock, User, ArrowRight, Briefcase, Eye, EyeOff } from "lucide-react";
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-2.5 bg-zinc-950 border border-zinc-800 rounded-xl text-xs text-white placeholder-zinc-500 focus:outline-none focus:border-indigo-500 transition-colors font-mono"
                  required
                />
                <button
                  type="button"
