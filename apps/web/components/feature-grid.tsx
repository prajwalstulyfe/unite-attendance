...
export function FeatureGrid() {
  return (
    <section id="features" className="py-20 px-6 md:px-12 bg-zinc-950">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16 space-y-3">
          <span className="text-xs font-extrabold text-indigo-400 uppercase tracking-widest">Enterprise Features</span>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight">Everything Needed for Total Attendance Control</h2>
          <p className="text-sm text-zinc-400 max-w-xl mx-auto font-medium">Built for high-density institutions, enterprises, and schools.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-6 rounded-2xl bg-zinc-900/60 border border-zinc-800 space-y-3">
            ...
            <h3 className="text-lg font-extrabold text-white">Dynamic Anti-Spoof QR</h3>
          ...
          <div className="p-6 rounded-2xl bg-zinc-900/60 border border-zinc-800 space-y-3">
            ...
            <h3 className="text-lg font-extrabold text-white">Geofencing & Wifi Check</h3>
            <p className="text-xs text-zinc-400 leading-relaxed font-medium">
          ...
          <div className="p-6 rounded-2xl bg-zinc-900/60 border border-zinc-800 space-y-3">
            ...
            <h3 className="text-lg font-extrabold text-white">Real-Time Telemetry</h3>
            <p className="text-xs text-zinc-400 leading-relaxed font-medium">
          ...
          <div className="p-6 rounded-2xl bg-zinc-900/60 border border-zinc-800 space-y-3">
            ...
            <h3 className="text-lg font-extrabold text-white">Department Gate Locking</h3>
            <p className="text-xs text-zinc-400 leading-relaxed font-medium">
          ...
          <div className="p-6 rounded-2xl bg-zinc-900/60 border border-zinc-800 space-y-3">
            ...
            <h3 className="text-lg font-extrabold text-white">Automated Grace Rules</h3>
            <p className="text-xs text-zinc-400 leading-relaxed font-medium">
          ...
          <div className="p-6 rounded-2xl bg-zinc-900/60 border border-zinc-800 space-y-3">
            ...
            <h3 className="text-lg font-extrabold text-white">Instant Export Engine</h3>
            <p className="text-xs text-zinc-400 leading-relaxed font-medium">
