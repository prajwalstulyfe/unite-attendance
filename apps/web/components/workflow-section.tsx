    ...
    <section id="workflow" className="py-20 px-6 md:px-12 bg-zinc-100/60 dark:bg-zinc-900/40 border-t border-zinc-200 dark:border-zinc-800/80 transition-colors">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-16 space-y-3">
          <span className="text-xs font-extrabold text-indigo-600 dark:text-indigo-400 uppercase tracking-widest">3 Simple Steps</span>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-zinc-900 dark:text-white tracking-tight">How Unite Attendance Works</h2>
          <p className="text-sm text-zinc-600 dark:text-zinc-400 font-medium">Deployment takes less than 5 minutes per campus.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          <div className="p-6 rounded-3xl bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 shadow-sm text-center space-y-4">
            ...
            <h3 className="text-lg font-extrabold text-zinc-900 dark:text-white">Setup Admin Rules</h3>
          ...
          <div className="p-6 rounded-3xl bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 shadow-sm text-center space-y-4">
            ...
            <h3 className="text-lg font-extrabold text-zinc-900 dark:text-white">Members Open Pass</h3>
            <p className="text-xs text-zinc-600 dark:text-zinc-400 leading-relaxed font-medium">
          ...
          <div className="p-6 rounded-3xl bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 shadow-sm text-center space-y-4">
            ...
            <h3 className="text-lg font-extrabold text-zinc-900 dark:text-white">Sub-Second Scan</h3>
            <p className="text-xs text-zinc-600 dark:text-zinc-400 leading-relaxed font-medium">
