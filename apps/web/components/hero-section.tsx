...
export function HeroSection() {
  ...
  return (
    <section className='pt-36 pb-20 px-6 md:px-12 max-w-7xl mx-auto text-center flex flex-col items-center relative overflow-hidden'>
      ...
      <motion.h1
        ...
        Attendance Made Simple. Business Made Smarter.
      </motion.h1>
      ...
      <motion.p
        ...
        Eliminate paper registers and messy Excel sheets. Unite Attendance is the precise, reliable platform built for
        real modern businesses from 10 to 10,000 employees.
      </motion.p>
      ...
      <motion.div
        ...
        <div className='bg-white/95 dark:bg-zinc-900/95 border border-zinc-200 dark:border-zinc-800/80 rounded-[28px] p-1 shadow-2xl shadow-indigo-500/10 dark:shadow-black/50 backdrop-blur-2xl relative overflow-hidden transition-colors'>
          ...
          <div className='flex items-center justify-between px-5 py-3 bg-zinc-100/90 dark:bg-zinc-950/80 rounded-t-3xl border-b border-zinc-200 dark:border-zinc-800/60 transition-colors'>
          ...
          <div className='p-6 md:p-8'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch'>
              ...
              <div className='rounded-2xl bg-linear-to-b from-zinc-50 to-zinc-100/80 dark:from-zinc-950 dark:to-zinc-950/80 border border-zinc-200 dark:border-zinc-800/60 overflow-hidden transition-colors'>
                {/* Panel Header */}
                ...
                <div className='p-6 flex flex-col items-center text-center space-y-4'>
                  ...
                  <div className='relative'>
                    <div className='absolute -inset-2 rounded-2xl bg-linear-to-r from-emerald-500/20 via-indigo-500/20 to-purple-500/20 blur-md animate-pulse' />
                  ...
                  <div className='flex items-center gap-3 px-4 py-2 rounded-xl bg-white dark:bg-zinc-900/80 border border-zinc-200 dark:border-zinc-800/60 shadow-sm'>
                    <div className='relative h-8 w-8'>
                      ...
                      <span className='absolute inset-0 flex items-center justify-center text-[10px] font-black text-indigo-600 dark:text-indigo-400'>
                        {totpTimer}
                      </span>
                    </div>
              ...
              <div className='rounded-2xl bg-linear-to-b from-zinc-50 to-zinc-100/80 dark:from-zinc-950 dark:to-zinc-950/80 border border-zinc-200 dark:border-zinc-800/60 overflow-hidden flex flex-col transition-colors'>
                {/* Panel Header */}
                <div className='flex items-center justify-between px-5 py-3.5 border-b border-zinc-200 dark:border-zinc-800/40 bg-zinc-100/60 dark:bg-zinc-950'>
                  <span className='text-xs font-bold text-zinc-800 dark:text-zinc-300 flex items-center gap-2'>
                ...
                <div className='p-6 flex-1 flex flex-col items-center justify-center text-center relative'>
                  ...
                  : <div className='space-y-5'>
                      ...
                      <div className='relative h-28 w-28 mx-auto'>
                        ...
                        {/* Laser line */}
                        <motion.div
                          className='absolute inset-x-2 h-0.5 bg-linear-to-r from-transparent via-indigo-500 to-transparent shadow-[0_0_10px_#6366f1]'
                      ...
                      <div className='space-y-1.5'>
                        ...
                        <p className='text-[11px] text-zinc-500 dark:text-zinc-500 font-medium max-w-50 mx-auto'>
